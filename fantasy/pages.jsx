...
(function () {
  ...
  function ParkPage(props) {
    ...
    return h('div', { className: 'fy-wrap fy-rise' },
      ...
      p.maps ? h('div', null,
        h('div', { style: { display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 8, margin: '12px 0 8px' } },
          h('div', { style: { fontWeight: 800, fontSize: 'calc(13px * var(--fz))', color: 'var(--fy-ink)' } }, 'Park map'),
          h('div', { style: { display: 'flex', gap: 8 } },
            h('a', { href: p.maps.official, target: '_blank', className: 'fy-a', style: { fontSize: 'calc(11px * var(--fz))', padding: '3px 10px', border: '1px solid var(--fy-stroke)', borderRadius: 999, textDecoration: 'none' } }, 'Map guide ↗'),
            h('a', { href: p.maps.pdf, target: '_blank', className: 'fy-a', style: { fontSize: 'calc(11px * var(--fz))', padding: '3px 10px', border: '1px solid var(--fy-stroke)', borderRadius: 999, textDecoration: 'none' } }, 'PDF / print ↗')
          )
        ),
        h('div', { style: { borderRadius: 'var(--fy-r)', overflow: 'hidden', border: '1px solid var(--fy-stroke)', marginBottom: 12 } },
          h('iframe', { src: p.maps.gmaps, width: '100%', height: 260, style: { border: 0, display: 'block' }, allowFullScreen: true, loading: 'lazy', referrerPolicy: 'no-referrer-when-downgrade' })
        )
      ) : null,
    ...
    return h('div', { className: 'fy-wrap fy-rise' },
      ...
      h('div', { className: 'fy-twocol' },
        h('div', null,
          ...
          h('div', { className: 'fy-hint', style: { marginBottom: 8 } }, 'Snapshot of Dec 1–14, 2025 rack rates (value season) · 2027 est. at ~5%/yr inflation · doesn\'t update with your trip date — peak weeks run 20–40% higher.'),
