...
(function () {
  ...
  function BookingTimeline(props) {
    ...
    return h('div', { className: 'fy-card', style: { padding: 0, overflow: 'hidden' } },
      h('div', { className: 'fy-collapse-head', style: { padding: '16px 20px' }, onClick: function () { setOpen(!open); } },
        h('div', { className: 'fy-rowwrap', style: { gap: 14 } },
          h('div', null,
            ...
            h('input', { type: 'date', className: 'fy-date', value: dateStr, onClick: function (e) { e.stopPropagation(); }, onChange: function (e) { pl.actions.setTripDate(e.target.value); } })
          ),
