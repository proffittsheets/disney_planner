var fireworksDNs={
  ...
  dessert:{l:'MK Fireworks Dessert Party',off:220,peak:220,
  ...
  ferrytale:{l:'Ferrytale Fireworks Dessert Cruise',off:260,peak:260,
    note:'Watch Happily Ever After from the iconic Magic Kingdom ferryboat on Seven Seas Lagoon · Desserts, drinks, glow-in-the-dark Hidden Mickey scavenger hunt, Mickey Vision fireworks lenses · Select Wednesday and Saturday evenings only · Check-in at Ticket and Transportation Center · $130/adult · tax & gratuity included (2026 price)',
  ...
  celebration:{l:'Celebration at the Top',off:420,peak:420,
    note:'California Grill 15th floor · Small plates, sushi, desserts, cocktails + wine · Step onto the private outdoor viewing deck for MK fireworks · Adults-focused · Smart casual dress code · Not offered every night — check Disney website · Different from the California Grill dinner reservation · $169/person + tax & gratuity (2026 price)',
  ...
  cagrill:{l:'California Grill Dinner',off:420,peak:420,
    ...
    hotel:'Best from: Contemporary (elevator up — zero logistics) · Polynesian and Grand Floridian easy via monorail'},
  mnsshp:{l:"Mickey's Not-So-Scary Halloween Party",off:690,peak:690,family:true,
    note:'Magic Kingdom · Aug–Oct select nights · 7pm–midnight · Includes: Disney\'s Not-So-Spooky Spectacular fireworks hosted by Jack Skellington, Boo-to-You Halloween Parade (headless horseman!), Hocus Pocus Villain Spelltacular stage show, trick-or-treating, exclusive character meets in Halloween costumes · $119–$229/ticket + tax (2026) · everyone ages 3+ needs a ticket — priced for all 4 of you · Dates sell out — book as soon as released, some dates sell out before Halloween',
  ...
  mvmcp:{l:"Mickey's Very Merry Christmas Party",off:875,peak:875,family:true,
    note:'Magic Kingdom · Nov–Dec 21 select nights · 7pm–midnight · Includes: Minnie\'s Wonderful Christmastime Fireworks, Mickey\'s Once Upon a Christmastime Parade, Mickey\'s Most Merriest Celebration castle show, free hot cocoa and cookies throughout the park, festive overlays on Space Mountain and more · $189–$229/ticket + tax (2026) · kids 3–9 save $10 · everyone ages 3+ needs a ticket — priced for all 4 of you · Sells out — every date sold out in 2025',
...
var eveningDNs={
  ...
  starlight:{l:'Starlight Safari',off:195,peak:195,
    note:'Animal Kingdom Lodge · 1-hour open-air nighttime safari through the resort savanna · Night vision goggles provided · 30+ species including zebras, giraffes, flamingos, and wildebeest · Runs at 8:30pm and 10pm nightly · Ages 8 and up · ~$89–$99/person (2026) · Book via My Disney Experience app',
...
var daytimeDNs={
  crt:{l:"Cinderella's Royal Table",off:315,peak:315,
    note:'Magic Kingdom · Character dining inside the castle · 3 adults + 1 child · $88/adult, $52/child incl. tax & gratuity (2026 lunch/dinner) · Sells out fast — book at exactly 60 days'},
  ...
  cfg:{l:'Caring for Giants',off:170,peak:170,
    note:'Animal Kingdom · 60-min elephant experience · all 4 guests · $39/person + tax (2026) · Walk alongside the herd, learn from the keepers, feed the elephants · Ages 4 and up — she must have turned 4 by the tour date · Book at 60 days'},
};
var fi=[
  ...
  {bk:'park',     label:'Park tickets',             note:'4-day base tickets × 4 people · date-based pricing — 2026 median is ~$659/person + tax, child tickets only $5/day less',color:'#0077B6',off:2300,peak:3200},
  ...
  {bk:'misc',     label:'Memory Maker / PhotoPass',  note:'Unlimited digital downloads of all Disney photographer shots · Ride photos included · Covers your whole party for the entire trip · $185 if bought 3+ days before arrival ($210 during the trip) · Worth every cent with an almost-4-year-old at her first trip',color:'#90E0EF',off:185,peak:185,isMemMaker:true},
  ...
  {bk:'misc',     label:'MagicBand+',               note:'4 bands × ~$45 avg · Lights up + vibrates during Happily Ever After, Luminous, Fantasmic! + show interactions · Optional — free Key to the World card works for park entry, Lightning Lane & room key',color:'#90E0EF',off:180,peak:180,isBand:true},
];
